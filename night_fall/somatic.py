...
BODY_TABLE: dict[str, dict[str, Any]] = {
    ...
    "肚子": {"sensitivity": 0.7, "temp": "温", "texture": "软"},
    "胸":   {"sensitivity": 0.7, "temp": "温", "texture": "有肉感"},
    "下巴": {"sensitivity": 0.5, "temp": "温", "texture": "骨感"},
    "鼻子": {"sensitivity": 0.5, "temp": "温", "texture": "软"},
    "鼻尖": {"sensitivity": 0.6, "temp": "温", "texture": "软"},
    "眼睛": {"sensitivity": 0.8, "temp": "温", "texture": "薄皮"},
    "眼皮": {"sensitivity": 0.8, "temp": "温", "texture": "薄皮"},
    "腋下": {"sensitivity": 0.8, "temp": "热", "texture": "薄皮"},
    "肋骨": {"sensitivity": 0.6, "temp": "温", "texture": "骨感"},
    "腰侧": {"sensitivity": 0.7, "temp": "温", "texture": "有肉感"},
    "屁股": {"sensitivity": 0.7, "temp": "温", "texture": "有肉感"},
    "小腿": {"sensitivity": 0.4, "temp": "温", "texture": "有肉感"},
    "脚":   {"sensitivity": 0.6, "temp": "温", "texture": "有肉感"},
    "脚心": {"sensitivity": 0.8, "temp": "温", "texture": "软"},
    "脚踝": {"sensitivity": 0.5, "temp": "温", "texture": "骨感"},
    "脚趾": {"sensitivity": 0.6, "temp": "温", "texture": "薄皮"},
    "指尖": {"sensitivity": 0.7, "temp": "温", "texture": "薄皮"},
    "手腕": {"sensitivity": 0.6, "temp": "温", "texture": "薄皮"},
    "胯":   {"sensitivity": 0.8, "temp": "热", "texture": "敏感"},
    "尾椎": {"sensitivity": 0.8, "temp": "温", "texture": "骨感"},
    "后颈": {"sensitivity": 0.8, "temp": "温", "texture": "薄皮"},
    "喉结": {"sensitivity": 0.7, "temp": "温", "texture": "骨感"},
    "太阳穴": {"sensitivity": 0.6, "temp": "温", "texture": "薄皮"},
}
